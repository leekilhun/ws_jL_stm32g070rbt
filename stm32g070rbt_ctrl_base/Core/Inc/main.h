...
/* Private defines -----------------------------------------------------------*/
#define LAMP_RESET_Pin GPIO_PIN_11
#define LAMP_RESET_GPIO_Port GPIOC
#define KEY_STOP_Pin GPIO_PIN_12
#define KEY_STOP_GPIO_Port GPIOC
#define LAMP_STOP_Pin GPIO_PIN_13
#define LAMP_STOP_GPIO_Port GPIOC
#define KEY_START_Pin GPIO_PIN_14
#define KEY_START_GPIO_Port GPIOC
#define LAMP_START_Pin GPIO_PIN_15
#define LAMP_START_GPIO_Port GPIOC
