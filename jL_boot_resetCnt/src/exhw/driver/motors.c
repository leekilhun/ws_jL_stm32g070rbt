...
static void motorISR_Axis3(void);
static void motorISR_Axis4(void);
...
bool motorStart(axis_dir axis)
{
  switch (axis)
  {
    ...
    case AXIS_3:
      motor_tbl[AXIS_3].func_dir                    = motorFuncDir;
      motor_tbl[AXIS_3].func_step                   = motorFuncStep;
      motor_tbl[AXIS_3].p_tim_handle                = timGetData(_DEF_TIM3);
      motor_tbl[AXIS_3].p_tim_handle->func_callback = motorISR_Axis3;
      timChangePrescale(_DEF_TIM3, 612);

      if (timStart(_DEF_TIM3) == false)
      {
        return false;
      }
      ...
      break;
    case AXIS_4:
      motor_tbl[AXIS_4].func_dir                    = motorFuncDir;
      motor_tbl[AXIS_4].func_step                   = motorFuncStep;
      motor_tbl[AXIS_4].p_tim_handle                = timGetData(_DEF_TIM4);
      motor_tbl[AXIS_4].p_tim_handle->func_callback = motorISR_Axis4;
      timChangePrescale(_DEF_TIM4, 612);

      if (timStart(_DEF_TIM4) == false)
      {
        return false;
      }
